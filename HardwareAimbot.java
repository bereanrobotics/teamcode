...
public class HardwareAimbot
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        frontLeftMotor  = initMotor("left_front", true);
        frontRightMotor = initMotor("right_front", false);
        backLeftMotor   = initMotor("left_back", true);
        backRightMotor  = initMotor("right_back", false);
